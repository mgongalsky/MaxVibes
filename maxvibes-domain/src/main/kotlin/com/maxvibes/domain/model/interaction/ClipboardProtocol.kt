...
data class InteractionResponse(
    ...
    /**
     * Описания записей из `modifications`, которые кодек не смог разобрать.
     *
     * Такие записи НЕ попадают в [modifications] и никогда не будут применены,
     * поэтому список обязан дойти до пользователя и до агента: молчаливая потеря
     * правки неотличима от «агент ничего не сделал» и стоит целого цикла работы.
     */
