...
data class ContextAwareResult(
    ...
    /** Commit message generated by LLM — plugin will insert it into the IDE commit dialog */
    val commitMessage: String? = null,
    /** Typed view requests from LLM response — used for coloured bubble rendering */
    val requestedViews: List<com.maxvibes.domain.model.code.RequestedViewInfo> = emptyList(),
    /** Shell-команды, запрошенные LLM — выполняются UI-слоем после подтверждения */
